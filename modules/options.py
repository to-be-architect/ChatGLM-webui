...
parser.add_argument("--precision", type=str, help="evaluate at this precision", choices=["fp16", "int4", "int8"],
                    default="fp16")

parser.add_argument("--listen", default="0.0.0.0", action='store_true',
...
parser.add_argument("--device-id", default="1", type=str, help="select the default CUDA device to use")
